...
export default function LetterGlitch({
  ...
  const getRandomColor = () => glitchColors.length ? glitchColors[Math.floor(Math.random() * glitchColors.length)] : '#000000';
  ...
  const updateLetters = () => {
    ...
    for (let i = 0; i < updateCount; i++) {
      ...
      letters.current[index].char = getRandomChar() || 'A';
      letters.current[index].targetColor = getRandomColor() || '#000000';
      if (!smooth) {
