    ...
    <PageShell sidebarItems={pharmacyNavItems} headerTitle="Settings" headerSubtitle="Business Hours">
      <div className="p-6">
        <div className="rounded-lg border border-rose-200/70 dark:border-rose-800/40 bg-white dark:bg-gray-900 p-6">
          <h2 className="text-lg font-semibold text-rose-800 dark:text-rose-200 mb-2">Business Hours – Coming Soon</h2>
          <p className="text-sm text-gray-700 dark:text-gray-300">Set opening hours within 48 hours.</p>
        </div>
      </div>
    </PageShell>
  )
