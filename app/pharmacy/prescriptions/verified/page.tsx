...
export default async function PharmacyRxVerifiedPage() {
  return (
    <PageShell sidebarItems={pharmacyNavItems} headerTitle="Prescriptions" headerSubtitle="Verified">
      <div className="p-6">
        <div className="rounded-lg border border-rose-200/70 dark:border-rose-800/40 bg-white dark:bg-gray-900 p-6">
          <h2 className="text-lg font-semibold text-rose-800 dark:text-rose-200 mb-2">Verified – Coming Soon</h2>
